...
public class KeyEvent extends InputEvent {
    ...
    static {
        ...
        AWTAccessor.setKeyEventAccessor(
            new AWTAccessor.KeyEventAccessor() {
                ...
                public void setPrimaryLevelUnicode(final KeyEvent ev,
                                                   final long primaryLevelUnicode) {
                    ev.primaryLevelUnicode = primaryLevelUnicode;
                }

                public void setExtendedKeyCode(final KeyEvent ev,
                                               final long extendedKeyCode) {
                    ev.extendedKeyCode = extendedKeyCode;
                }

                public Component getOriginalSource( final KeyEvent ev ) {
    ...
    private KeyEvent(final Component source, final int id, final long when, final int modifiers,
                    final int keyCode, final char keyChar, final int keyLocation, final boolean isProxyActive) {
     ...
     * @since 1.4
     */
    public KeyEvent(final Component source, final int id, final long when, final int modifiers,
        ...
        //System.out.println("neo keycode: " + neoKeyCode);
    ...
    public static String getKeyText(final int keyCode) {
        ...
        if (keyCode >= VK_NUMPAD0 && keyCode <= VK_NUMPAD9) {
            final String numpad = Toolkit.getProperty("AWT.numpad", "NumPad");
            final char c = (char)(keyCode - VK_NUMPAD0 + '0');
            return numpad + "-" + c;
        }
        ...
        final String unknown = Toolkit.getProperty("AWT.unknown", "Unknown");
     ...
     *
     */
    public static int getExtendedKeyCodeForChar(final int c) {
